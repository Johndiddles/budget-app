            ...
            <Card.Body>
                <Card.Title className="d-flex justify-content-between align-items-baseline fw-normal mb-3">
                    ...
                    <div className="d-flex align-items-baseline">
                        ...
                        {max && ( <span className="text-mutedd fs-6 ms-1"> / {currencyFormatter.format(max)}</span>)}
                    </div>
                </Card.Title>
                ...
                {!hideButtons && (<Stack direction="horizontal" gap="2" className="mt-4" >
                    <Button variant="outline-success" className="ms-auto" onClick={onAddExpenseClick}>Add Expense</Button>
